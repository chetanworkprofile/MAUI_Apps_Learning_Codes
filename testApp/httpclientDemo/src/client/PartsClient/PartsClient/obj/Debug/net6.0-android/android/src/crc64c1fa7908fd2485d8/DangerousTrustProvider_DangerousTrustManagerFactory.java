...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyApp.Platforms.Android.DangerousTrustProvider+DangerousTrustManagerFactory, PartsClient", DangerousTrustProvider_DangerousTrustManagerFactory.class, __md_methods);
	}
	...
	public DangerousTrustProvider_DangerousTrustManagerFactory ()
	{
		...
		if (getClass () == DangerousTrustProvider_DangerousTrustManagerFactory.class)
			mono.android.TypeManager.Activate ("MyApp.Platforms.Android.DangerousTrustProvider+DangerousTrustManagerFactory, PartsClient", "", this, new java.lang.Object[] {  });
	}
