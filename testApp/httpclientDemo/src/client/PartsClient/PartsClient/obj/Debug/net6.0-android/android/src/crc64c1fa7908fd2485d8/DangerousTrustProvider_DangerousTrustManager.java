...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyApp.Platforms.Android.DangerousTrustProvider+DangerousTrustManager, PartsClient", DangerousTrustProvider_DangerousTrustManager.class, __md_methods);
	}
	...
	public DangerousTrustProvider_DangerousTrustManager ()
	{
		...
		if (getClass () == DangerousTrustProvider_DangerousTrustManager.class)
			mono.android.TypeManager.Activate ("MyApp.Platforms.Android.DangerousTrustProvider+DangerousTrustManager, PartsClient", "", this, new java.lang.Object[] {  });
	}
