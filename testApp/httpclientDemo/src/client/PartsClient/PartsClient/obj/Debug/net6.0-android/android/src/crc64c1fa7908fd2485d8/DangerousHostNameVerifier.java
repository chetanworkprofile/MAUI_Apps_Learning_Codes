...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyApp.Platforms.Android.DangerousHostNameVerifier, PartsClient", DangerousHostNameVerifier.class, __md_methods);
	}
	...
	public DangerousHostNameVerifier ()
	{
		...
		if (getClass () == DangerousHostNameVerifier.class)
			mono.android.TypeManager.Activate ("MyApp.Platforms.Android.DangerousHostNameVerifier, PartsClient", "", this, new java.lang.Object[] {  });
	}
